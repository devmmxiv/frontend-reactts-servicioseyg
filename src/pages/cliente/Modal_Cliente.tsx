...
const ModalCliente: FC<props> = ({ cliente, update, onChange, ManejadorDirecciones, ManejadorCuenta, onSaveChanges, show, mensaje, toogle }: props): JSX.Element => {
                    ...
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={(e)=>setShowAlert(false)}>Cerrar</button>
                                <button type="button" className="btn btn-primary" onClick={onSave}>{cliente.id === 0 ? 'Grabar' : 'Grabar Cambios'}</button>
                            </div>
                        </div>
                    </div>
                </div>
